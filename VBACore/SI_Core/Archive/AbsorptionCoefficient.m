function [AlphaKSitu, AlphakLab, AlphAvg] = AbsorptionCoefficient(Elements)
%
% This Function Calculates the Absorption Coefficient for airborne in accordance with ISO 717-1
%
% INPUTS:
