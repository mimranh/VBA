function [TauLab, TauSituGen, TauSitu] = SI_TansmissionCoefficientSingle(MassElement, EtaTotalLab1, SigmaFW, SigmaForced, EtaTotalSituGeneral, EtaTotalSitu, fc, cL, Rho)
%
