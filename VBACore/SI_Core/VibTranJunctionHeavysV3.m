function [KIJ] = VibTranJunctionHeavysV3(ElementID, Method)
%
% This Faction Calculates the Vibration transmission over junctions: Case of heavy buildings Kij
%
% INPUTS:
...
elseif strcmp(ElementID, 'RWallB')
    ...
    JunctionAttched{2}.Elements = [RWallB.Mass, RWallR.Mass];
    JunctionAttched{3}.Elements = [RWallB.Mass, RWallB.Mass];
    JunctionAttched{4}.Elements = [RWallB.Mass, Partion.Mass];
    ...
    if strcmp(Method, 'Empirical')
        switch JunctionsType
            case 'CrossJunction'
                ...
                K13 = 8.7 + 17.1 * MK12Ratio + 5.7 * MK12Ratio.^2;
                K14 = K12;
                K21 = K12;
                K23 = K12;
                K24 = 8.7 + 17.1 * MK12Ratio + 5.7 * MK12Ratio.^2;
                K31 = K13;
                K32 = K23;
                K34 = K12;
                K41 = K14;
            ...
            case 'WallJunctionFlexibleInterLayer'
                % Under Construction K24 = 3.0+14.1*MRatio+5.7*MRatio.^2;
